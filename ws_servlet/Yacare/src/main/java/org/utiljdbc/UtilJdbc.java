...
import org.utiljdbc.ex.ExFindDao;
import org.utiljdbc.ex.ExFindJsonDao;
import org.utiljdbc.ex.ExUnexpectedResult;
...
public class UtilJdbc {
	...
	public Object findToJsonById(ConnectionWrapper connectionWrapper, String sql, Class clazz, String id) {
	...
	public Object findToJsonByExample(ConnectionWrapper connectionWrapper, String sql, Class clazz, Object... args) {
	...
	public Object[] findToJson(ConnectionWrapper connectionWrapper, String sql, Class clazz, Object... args) {
		...
		try {
			...
			return executeQueryToJson(connectionWrapper, preparedStatement, clazz);
	...
	private Object[] executeQueryToJson(ConnectionWrapper connectionWrapper, PreparedStatement preparedStatement, Class clazz) {
		...
		try {
			...
			ExFindJsonDao ex = new ExFindJsonDao(this.getClass(), e, connectionWrapper, json);
